        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.topBar}>
            ...
            <View style={styles.headerTitleContainer}>
              ...
              <View>
                <Text style={[styles.headerTitle, { fontFamily: fontFamily.extraBold }]}>Add Product</Text>
                <Text style={[styles.headerSubtitle, { fontFamily: fontFamily.medium }]}>List to marketplace</Text>
              </View>
            </View>
          </View>
        </View>
            ...
            {uploading && (
              <View style={styles.progressContainer}>
                <View style={styles.progressHeader}>
                  ...
                  <Text style={[styles.progressTitle, { fontFamily: fontFamily.semiBold }]}>Publishing Your Product</Text>
                </View>
          ...
          <TouchableOpacity style={[styles.publishButton, uploading && styles.publishButtonDisabled]} onPress={handleAddProduct} disabled={uploading} activeOpacity={0.85}>
            {uploading ? (
              ...
              <View style={styles.buttonContent}>
                ...
                <Text style={[styles.publishButtonText, { fontFamily: fontFamily.bold }]}>Publish Product</Text>
