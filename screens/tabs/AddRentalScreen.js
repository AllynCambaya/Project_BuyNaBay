        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.topBar}>
            ...
            <View style={styles.headerTitleContainer}>
              ...
              <View>
                <Text style={[styles.headerTitle, { fontFamily: fontFamily.extraBold }]}>List Rental</Text>
                <Text style={[styles.headerSubtitle, { fontFamily: fontFamily.medium }]}>Earn from your items</Text>
              </View>
            </View>
          </View>
        </View>
            ...
            {uploading && (
              <View style={styles.progressContainer}>
                <View style={styles.progressHeader}>
                  ...
                  <Text style={[styles.progressTitle, { fontFamily: fontFamily.semiBold }]}>Publishing Your Rental</Text>
                </View>
          ...
          <TouchableOpacity style={[styles.publishButton, uploading && styles.publishButtonDisabled]} onPress={submit} disabled={uploading} activeOpacity={0.85}>
            {uploading ? (
              <View style={styles.buttonContent}>
                ...
                <Text style={[styles.publishButtonText, { fontFamily: fontFamily.bold }]}>Publishing...</Text>
              </View>
            ) : (
              <View style={styles.buttonContent}>
                <Ionicons name="rocket" size={20} color="#fff" />
                <Text style={[styles.publishButtonText, { fontFamily: fontFamily.bold }]}>Publish Rental Item</Text>
